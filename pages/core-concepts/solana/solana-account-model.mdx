...
<Callout>
  ...
  With the exception of adding SOL to an account, which can be done by any account.
</Callout>
...
1. **Program Account**: The primary account representing the program and stores the address of the executable data account.
2. **Program Executable Data Account**: Dedicated to storing the executable byte code of the program.
